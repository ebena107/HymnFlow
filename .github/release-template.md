## HymnFlow Release Notes

### 📦 What's New

[Add release notes here - extracted from CHANGELOG.md]
...
- 🎵 Full hymn management (add, edit, delete, search)
- ⌨️ Keyboard-driven navigation (arrow keys)
- 🎨 Customizable styling (fonts, colors, effects)
- 📥 Import/export hymns (.txt, .json, .csv)
- 🎯 Smart verse navigation with auto-advance
- 👁️ Real-time overlay display
